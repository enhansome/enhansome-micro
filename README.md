...
[<img align="right" src="https://camo.githubusercontent.com/67335088cb7b156fb779f6d60635e70780efe714/68747470733a2f2f636c6475702e636f6d2f4a446d6d4858337568462e737667" />](https://github.com/vercel/micro) ⭐ 10,630 | 🐛 8 | 🌐 TypeScript | 📅 2026-05-21

> A collection of awesome things regarding Vercel's [Micro](https://github.com/zeit/micro) ⭐ 10,630 | 🐛 8 | 🌐 TypeScript | 📅 2026-05-21 — Asynchronous HTTP microservices.
...
* [micro-morgan](https://github.com/nickcis/micro-morgan) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2019-03-21 - [Morgan](https://github.com/expressjs/morgan) ⭐ 8,203 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-11 HTTP request logger middleware for Zeit's Micro framework.
...
* [serve-handler](https://github.com/zeit/serve-handler) ⭐ 618 | 🐛 88 | 🌐 JavaScript | 📅 2026-05-04 - Static file serving and directory listing handler, used by [Serve](https://github.com/zeit/serve) ⭐ 9,904 | 🐛 151 | 🌐 TypeScript | 📅 2026-06-30
...
* [nuxt-micro](https://github.com/nuxt-community/micro-template) ⭐ 73 | 🐛 2 | 🌐 JavaScript | 📅 2020-12-11 - A [Vue-CLI](https://github.com/vuejs/vue-cli) ⭐ 29,534 | 🐛 1,069 | 🌐 JavaScript | 📅 2025-08-21 template to generate a [Nuxt.js](https://github.com/nuxt/nuxt.js) ⭐ 60,904 | 🐛 481 | 🌐 TypeScript | 📅 2026-09-24 project with micro as a backend
* [create-micro](https://github.com/romuloalves/create-micro) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2024-04-27 - a generator for `micro` projects

## Articles & FAQ

* [Regarding no-middleware](https://github.com/vercel/micro/issues/8) ⭐ 10,630 | 🐛 8 | 🌐 TypeScript | 📅 2026-05-21
* [Use Micro with routes](https://github.com/vercel/micro/issues/16#issuecomment-193518395) ⭐ 10,630 | 🐛 8 | 🌐 TypeScript | 📅 2026-05-21
* [Difference between Micro and Koa](https://github.com/vercel/micro/issues/309#issuecomment-332503863) ⭐ 10,630 | 🐛 8 | 🌐 TypeScript | 📅 2026-05-21
* [Minimum Viable Async with Node 6](https://gist.github.com/rauchg/8199de60db48026a6670620a1c33b700)

## Built with Micro

* [Serve](https://github.com/vercel/serve) ⭐ 9,904 | 🐛 151 | 🌐 TypeScript | 📅 2026-06-30 - Static file serving and directory listing
