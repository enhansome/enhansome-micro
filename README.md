...
* [micro-notify](https://github.com/pauldariye/micro-notify) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2019-08-06 - A simple [.notify](https://github.com/bugsnag/bugsnag-js) ⭐ 893 | 🐛 89 | 🌐 TypeScript | 📅 2026-09-16 wrapper to send micro errors to Bugsnag.
...
* [serve-handler](https://github.com/zeit/serve-handler) ⭐ 618 | 🐛 88 | 🌐 JavaScript | 📅 2026-05-04 - Static file serving and directory listing handler, used by [Serve](https://github.com/zeit/serve) ⭐ 9,899 | 🐛 151 | 🌐 TypeScript | 📅 2026-06-30
...
* [nuxt-micro](https://github.com/nuxt-community/micro-template) ⭐ 73 | 🐛 2 | 🌐 JavaScript | 📅 2020-12-11 - A [Vue-CLI](https://github.com/vuejs/vue-cli) ⭐ 29,540 | 🐛 1,069 | 🌐 JavaScript | 📅 2025-08-21 template to generate a [Nuxt.js](https://github.com/nuxt/nuxt.js) ⭐ 60,865 | 🐛 477 | 🌐 TypeScript | 📅 2026-09-16 project with micro as a backend
